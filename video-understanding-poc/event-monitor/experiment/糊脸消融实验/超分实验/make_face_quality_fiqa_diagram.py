...
svg.append(arrow(70, 390, 40, 720, "检测失败", COLORS["red"][0]))
...
svg.append(arrow(735, 280, 755, 280, "并行信号", COLORS["purple"][0], "6 5"))
...
svg.append(arrow(350, 530, 450, 280, "检测结果"))
...
svg.append(arrow(800, 955, 1290, 955))
...
svg.append(arrow(380, 765, 450, 1170, "人脸不可用"))
...
svg.append(arrow(380, 1030, 755, 360, "FIQA配置与模型", COLORS["purple"][0], "7 5"))
